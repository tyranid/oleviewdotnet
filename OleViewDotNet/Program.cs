...
namespace OleViewDotNet
{
    ...
    static public class Program
    {
        class UnsafeNativeMethods
        {
            ...
            static int CoInitializeSecurity_DynamicLoading()
            {
                return CoInitializeSecurity(IntPtr.Zero, -1, IntPtr.Zero, IntPtr.Zero, AuthnLevel.RPC_C_AUTHN_LEVEL_DEFAULT,
            ...
            {
                static readonly int _security_init = CoInitializeSecurity_DynamicLoading();
                public bool is_secure
                {
                    get
                    {
                        return _security_init == 0;
                    }
                    set
                    {
                    }
        ...
        static readonly UnsafeNativeMethods.CoSecurity _security_init = new UnsafeNativeMethods.CoSecurity();
        /// <summary>
        ...
        {
            Debug.Assert(_security_init.is_secure);
